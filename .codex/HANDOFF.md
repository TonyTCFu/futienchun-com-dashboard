...
更新时间：2026-06-23 23:12 Asia/Shanghai
...
- 当前公网已验证版本：待二次补跑推送后回看确认
- 今日 Dashboard 更新日期：`2026-06-23`
- 行情/回测最新日期：`2026-06-23`
- 模型盘市值日：`2026-06-23`
- 行情口径：`收盘定稿`
- 当前快照时间：`2026-06-23T23:12:07`
- 加权指数：TWSE 公开资料二次补跑时已可读取 2026-06-23 月资料，模型盘市值档已推进
- 最后回测调仓日：`2026-06-17`
- 预计下次回测调仓：`2026-06-29`
- 待确认调仓：`0`
...
- `data/simulated_trades_2026-06-23.csv` 为二次补跑后 3 笔本地模拟成交记录，重跑保持幂等。
- 成交：
  - `2317` 卖出 `5` 股
  - `2881` 卖出 `38` 股
  - `2882` 卖出 `39` 股
...
本轮本地验证已通过；公网验证待推送后执行：

- 可检索 `update-summary-list`
- 可检索「今日 Dashboard 更新日期：2026-06-23」
- 可检索「行情/回测序列最新日期：2026-06-22」
- 可检索「已按每日 13:45 更新」
