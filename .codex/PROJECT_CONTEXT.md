...
- 2026-06-25 调仓日历为：最后回测调仓日 `2026-06-17`，预计下次回测调仓 `2026-06-29`，距下次还差 `4` 个共同交易日；研究摘要 QA 基线同步为 `33.00% / 52.71% / +19.71% / trade_count=2`，本地 QA 汇总通过；公网 Render 正文已验证切到 `2026-06-25` / `2026-06-24`，但 `origin/main` 因 Antigravity/300k TWD 分叉未推送成功。
