...
- 提交 `0d61b81` 已推送到 `dashboard` 远端；Render 首页正文第 2 轮切到 `今日 Dashboard 更新日期：2026-06-25` 与 `行情/回测序列最新日期：2026-06-24`。`origin/main` 因远端 Antigravity/300k TWD 分叉仍拒绝快进推送，本轮未强推。
