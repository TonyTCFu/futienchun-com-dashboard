...
- 手动补跑已成功重建 Dashboard，但公开收盘价共同交易日仍停在 `2026-07-09`；本轮只推进快照时间与 QA 基线，不得把 `2026-07-13` 误报为行情日期。
- 本轮研究摘要关键数字漂移为 `AI 供应链权重 32.56%`、`风险贡献 52.45%`、`风险-权重差 +19.89%`、`trade_count=2`，已同步到 QA 脚本和 iCloud Obsidian `台股量化基金.md`。
